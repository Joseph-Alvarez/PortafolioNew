...
if ( typeof module === 'object' ) {
  ...
  var animation = bodymovin.loadAnimation({
    ...
    loop: true,
    autoplay: true,
    path: '../backend-PORTA/96143-developer.json',
  });
    ...
    var animacion = bodymovin.loadAnimation({
      ...
      loop: true,
      autoplay: true,
      path: '../backend-PORTA/109028-lenguajes.json',
    });
  ...
  var animacion = bodymovin.loadAnimation({
    ...
    loop: true,
    autoplay: true,
    path: '../backend-PORTA/131633-game.json'
  });
  ...
  var animacion = bodymovin.loadAnimation({
    ...
    loop: true,
    autoplay: true,
    path: '../backend-PORTA/110472-mobile.json'
  });
  ...
  var animacion = bodymovin.loadAnimation({
    ...
    loop: true,
    autoplay: true,
    path: '../backend-PORTA/34260-program.json'
  });